    ...
    $.fn.chained = function(parentSelector) {
        return this.each(function() {
            ...
            function updateChildren() {
                ...
                var currentlySelectedValue = $("option:selected", child).attr('data-value');
                ...
                var selected = "";
                $(parentSelector).each(function() {
                    var selectedValue = $("option:selected", this).attr('data-value');
                    if (selectedValue) {
                ...
                var selectedFirst = $("option:selected", first).attr('data-value');
